...
function PEReadUploaderTest(url, auth, auth_cb, timeout, async_job_check_time_ms) {
    var self = this;
    ...
    var _auth_cb = auth_cb;
     ...
     this.upload = function (params, _callback, _errorCallback) {
        ...
        return json_call_ajax("PEReadUploaderTest.upload",
